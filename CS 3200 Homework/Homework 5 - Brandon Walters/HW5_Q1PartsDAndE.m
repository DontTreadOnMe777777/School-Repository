...
for n = 3:6
    ...
    solutions = -x; % Get the proper coefficients
    ...
    if n == 3
        LSR2 = 0;
        for i = 1:11
            LSR2 = LSR2 + ((solutions(3) * years(i)^2 + solutions(2) * years(i) + solutions(1)) - populations(i))^2;
        end
        fprintf('%i LSR = %.4f\n', n-1, LSR2)
    end
    ...
    if n == 4
        LSR3 = 0;
        for i = 1:11
            LSR3 = LSR3 + ((solutions(4) * years(i)^3 + solutions(3) * years(i)^2 + solutions(2) * years(i) + solutions(1)) - populations(i))^2;
        end
        fprintf('%i LSR = %.4f\n', n-1, LSR3)
    end
    ...
    if n == 5
        LSR4 = 0;
        for i = 1:11
            LSR4 = LSR4 + ((solutions(5) * years(i)^4 + solutions(4) * years(i)^3 + solutions(3) * years(i)^2 + solutions(2) * years(i) + solutions(1)) - populations(i))^2;
        end
        fprintf('%i LSR = %.4f\n', n-1, LSR4)
    end
    ...
    if n == 6
        LSR5 = 0;
        for i = 1:11
            LSR5 = LSR5 + ((solutions(6) * years(i)^5 + solutions(5) * years(i)^4 + solutions(4) * years(i)^3 + solutions(3) * years(i)^2 + solutions(2) * years(i) + solutions(1)) - populations(i))^2;
        end
        fprintf('%i LSR = %.4f\n', n-1, LSR5)
    end
