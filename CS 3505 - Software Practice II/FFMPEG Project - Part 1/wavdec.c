...
static int wav_read_header(AVFormatContext *s)
{
    ...
    static int static_message = 0;

    // Added by us
    if (static_message == 0) {
      av_log(NULL, AV_LOG_INFO, "*** CS 3505 Spring 2020: Running code in wav_read_header in the file wavdec.c, which is in the libavformat folder ***\n*** CS 3505 Spring 2020: Changed by Jose Mattam and Brandon Walters ***\n");
      static_message = 1;
    }
