...
public class Ship extends Participant implements AsteroidDestroyer, AlienDestroyer, AlienBulletDestroyer
{
    ...
    private Shape outlineWT;

    /** The outline of the ship without the thruster */
    private Shape outlineWOT;

    /** Game controller */
    private Controller controller;

    /** Used to flicker the thruster */
    ...
    public Ship (int x, int y, double direction, Controller controller)
    {
        ...
        // Creates the outline without the flame
        ...
        // Creates the outline with the flame
    ...
    {
        // If the flame should be showing, returns the outline with flame
        if (thrusterOn)
        {
            return outlineWT;
        }

        // If the flame should not be showing, returns the outline without flame
        else
        {
            return outlineWOT;
        }
    ...
    public void flickerThruster (boolean thrusterOn)
    {
